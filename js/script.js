...
var ShowerSounds = ["Shampoo.m4a", "BrushingTeeth.m4a", "HairProduct.m4a", "Pumping.m4a", "WaterRunning.m4a"]
var color = ["#D5FFC6", "#B3F5E9", "#EDD3FD", "#F2FDD3", "#FDD3E9", "#FDECD3"];
var monologues = ["2_cat.mp3", "2_cat.mp3", "1_istanbul.mp3", "1_istanbul.mp3", "3_cafe.mp3","3_cafe.mp3"]
...
document.getElementById("Wall").onclick = function() {
    ...
    i = (i + 1 + Math.floor(Math.random() * 5))%5;
